...
export function InstallPrompt() {
    ...
    return (
        <div
            dir="rtl"
            className="fixed bottom-4 inset-x-4 sm:inset-x-auto sm:right-4 sm:max-w-sm z-50 bg-bg-surface border border-border-subtle rounded-2xl shadow-lg p-4 flex items-start gap-3 animate-in fade-in slide-in-from-bottom-4 duration-300"
        >
